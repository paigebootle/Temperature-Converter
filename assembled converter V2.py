...
class Converter:
    def __init__(self):
        ...
        self.temp_heading_label = Label(self.converter_frame, text="Temperature Converter",
                                        font="Arial 19 bold", bg=background_color, padx=10,
                                        pady=10)
        self.temp_heading_label.grid(row=0)

        # user instructions (row 1)
        self.temp_instructions_label = Label(self.converter_frame, text="Type in the amount to be converted"
                                             " and then push one of the buttons below...", font="Arial 10 italic",
                                             wrap=290, justify=LEFT, bg=background_color, padx=10, pady=10)
        ...
        self.conversion_button_frames = Frame(self.converter_frame)
        self.conversion_button_frames.grid(row=3, pady=10)

        self.to_c_button = Button(self.conversion_button_frames, text="To Centigrade", font="Arial 10 bold",
                                  bg="Khaki1", padx=10, pady=10, command=lambda: self.temp_convert(-459))
        self.to_c_button.grid(row=0, column=0)

        self.to_f_button = Button(self.conversion_button_frames, text="To Fahrenheit", font="Arial 10 bold",
                                  bg="Orchid1", padx=10, pady=10, command=lambda: self.temp_convert(-273))
        self.to_f_button.grid(row=0, column=1)

        # answer label (row 4)
        self.converted_label = Label(self.converter_frame, font="Arial 14 bold", fg="purple", bg=background_color,
        ...
        self.history_button = Button(self.hist_help_frame, font="Arial 12 bold", text="Calculation History",
                                     width=15, command=lambda: self.history(self.all_calc_list))
...
class History:
    def __init__(self, partner, calc_history):
        ...
        self.history_text = Label(self.history_frame, text="Here are your most recent "
                                  ...
                                  "export button to create a text file of all your "
                                  "calculations for this session", justify=LEFT,
                                  bg=background, wrap=250, font="arial 10 italic",
        ...
        if len(calc_history) >= 7:
            ...
            for item in calc_history:
                ...
                self.history_text.config(text="Here is the calculation history. "
...
class Export:
    def __init__(self, partner, calc_history):
        ...
        self.export_text = Label(self.export_frame, text="If the file you enter below already exists, "
